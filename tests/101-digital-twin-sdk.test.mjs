...
test('101: patient BFF disables, resumes, and offboards the private twin link', async () => {
  ...
  // The real BFF performs this once in the server-side index-enrollment
  // transaction, persists the value and reuses it below. It is never browser
  // state and is never regenerated by a permit/deny request.
