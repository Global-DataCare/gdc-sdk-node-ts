...
The high-level orchestration reads the created employee resource id and sends
it as the licence `subjectId` beside the public `subjectDid`; application code
must not reconstruct or substitute that technical binding.
